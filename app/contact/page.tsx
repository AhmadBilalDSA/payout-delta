      ...
      <ul className="mt-8 divide-y divide-slate-200 rounded-2xl border border-slate-200 bg-white dark:divide-white/[0.08] dark:border-white/[0.08] dark:bg-slate-900">
        <li className="flex flex-col gap-2 p-5 sm:flex-row sm:items-center sm:justify-between">
          ...
          <a
            ...
            className="rounded-lg border border-slate-300 px-4 py-2 text-sm font-medium text-slate-700 transition-colors hover:border-emerald-500 hover:text-emerald-700 dark:border-white/20 dark:text-white/70 dark:hover:border-emerald-400 dark:hover:text-emerald-400"
          >
            {CONTACT_EMAIL}
          </a>
        </li>
        <li className="flex flex-col gap-2 p-5 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <p className="font-semibold text-slate-900 dark:text-white">Fee corrections</p>
            <p className="text-sm text-slate-600 dark:text-white/60">
