  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl px-4 pb-16 pt-16 text-center sm:px-6 sm:pb-24 sm:pt-24">
        <h1
          id="hero-heading"
          className="mx-auto max-w-3xl text-4xl font-bold tracking-tight text-slate-900 text-balance sm:text-5xl lg:text-6xl"
        >
          Stop losing{" "}
          <span className="tabular-nums text-emerald-600">4.2%</span> on
